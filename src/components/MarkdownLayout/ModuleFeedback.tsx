            ...
            <span className="inline-flex rounded-md shadow-sm">
              <button
                ...
                className={`inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-white ${
                  submitEnabled
                    ? 'bg-blue-600 dark:bg-blue-900 hover:bg-blue-500 dark-hover:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 active:bg-blue-700'
